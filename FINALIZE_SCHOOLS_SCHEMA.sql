-- ==========================================
-- ADD SCHOOL ENHANCED SCHEMA - FIX MISSING COLUMNS
-- ==========================================

-- Add the missing short_name column to the schools table
ALTER TABLE public.schools
ADD COLUMN IF NOT EXISTS short_name TEXT;

-- Re-run the previous script just in case it wasn't run
ALTER TABLE public.schools
